...
def load_data_with_split(in_file, word_dict, rel_dict, out_file, normal_file, epo_file, seo_file):
...
if __name__ == '__main__':
    ...
    load_data('train.json', word_dict, rel_dict, 'new_train.json')
    load_data('valid.json', word_dict, rel_dict, 'new_valid.json')
    load_data_with_split('test.json', word_dict, rel_dict, 'new_test.json', 'new_test_normal.json', 'new_test_epo.json', 'new_test_seo.json')
